...
/*
    ...
    left(p) – връща лявото дете на възела на позиция p;
    right(p) – връща дясното дете на възела на позиция p;
    parent(p) – връща родителя на възела на позиция p;
    root() – връща върха на Хипа;
    last() – връща последният добавен елемент в Хипа;
    isRoot(p) – връща true, ако възела на позиция p е корен и false, в противен случай;
