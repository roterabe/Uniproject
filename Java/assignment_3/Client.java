public class Client {
    ...
    /*
     * public void rent(Studio studio) { this.studio = studio; studio.rent(hours);
     * int remaining = studio.left(); if (hours > studio.left()) {
     * System.out.println("Unable to rent the studio for: " + hours + " hours.");
     * System.out.println("You can rent the studio only for: " + studio.left() +
     * " hours."); } else System.out.println("Successfully rented the studio for: "
     * + hours + " hours."); }
     */
